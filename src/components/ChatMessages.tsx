...
function CardBubble({ msg, isMe, onPreviewContact, radius }: { msg: ConvMessage; isMe: boolean; onPreviewContact?: (id: string) => void; radius?: string }) {
  ...
  return (
    ...
    >
      <div className="w-11 h-11 rounded flex items-center justify-center font-semibold text-white flex-shrink-0" style={{ backgroundColor: card.cardAvatarColor || '#888', fontSize: 16 }}>
            ...
            >
              ...
              {multiSelect ? (
                ...
                <div
                  ...
                  className="w-9 h-9 flex-shrink-0 rounded flex items-center justify-center font-semibold text-white cursor-pointer"
