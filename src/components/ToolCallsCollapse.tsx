        ...
        >
          <div className="flex items-center gap-2 px-3 py-2">
            {isRunning ? (
              ...
              <CheckCircle2 style={{ color: 'var(--td-success-color)' }} />
            ) : (
              <XCircle style={{ color: 'var(--td-error-color)' }} />
            )}
      ...
      return (
        ...
        >
          ...
          >
            ...
            {command && (
              toolExpanded ? (
                <ChevronUp size={14} style={{ color: 'var(--td-text-color-placeholder)' }} />
              ) : (
                <ChevronDown size={14} style={{ color: 'var(--td-text-color-placeholder)' }} />
              )
            )}
          </div>
  ...
  const renderCollapseBar = () => (
    ...
    >
      ...
      <div className="flex items-center gap-1.5">
        {isExpanded ? (
          <ChevronUp size={16} style={{ color: 'var(--td-text-color-secondary)' }} />
        ) : (
          <ChevronDown size={16} style={{ color: 'var(--td-text-color-secondary)' }} />
        )}
        {hasRunning ? (
          <Loading size="small" />
        ) : hasError ? (
          <XCircle size={16} style={{ color: 'var(--td-error-color)' }} />
        ) : (
          <CheckCircle2 size={16} style={{ color: 'var(--td-success-color)' }} />
        )}
        <span
          className="text-sm"
          style={{ color: 'var(--td-text-color-primary)' }}
      ...
      <div className="space-y-2">
        {previousCount > 0 && (
          ...
          >
            <div className="flex items-center gap-1.5">
              <ChevronDown size={14} style={{ color: 'var(--td-text-color-placeholder)' }} />
              <CheckCircle2 size={14} style={{ color: 'var(--td-success-color)' }} />
              <span
                className="text-xs"
